...
$url = $arResult["FOLDER"] . str_replace(array("#PARAM1#", "#PARAM2#"), array(!empty($arResult["VARIABLES"]["PARAM1"]) ?: '123', !empty($arResult["VARIABLES"]["PARAM2"]) ?: '987'), $arResult["URL_TEMPLATES"]["exampage"]);
